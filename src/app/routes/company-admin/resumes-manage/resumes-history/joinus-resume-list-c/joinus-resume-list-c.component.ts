...
@Component({
  selector: 'app-joinus-resume-list-c',
  templateUrl: './joinus-resume-list-c.component.html',
  styleUrls: ['./joinus-resume-list-c.component.less']
})
export class JoinusResumeListCComponent implements OnChanges, OnInit {
