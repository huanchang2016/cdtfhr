...
@Component({
  selector: 'app-user-internship-exp-form-c',
  templateUrl: './user-internship-exp-form-c.component.html',
  styleUrls: ['./user-internship-exp-form-c.component.less']
})
export class UserInternshipExpFormCComponent implements OnChanges, OnInit {
  @Input() index:number;
